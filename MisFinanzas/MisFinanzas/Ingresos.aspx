<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pagina_Maestra.Master" CodeBehind="Ingresos.aspx.vb" Inherits="MisFinanzas.Ingresos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container py-5">
        <h2 class="text-center mb-4">Ingresos</h2>
        <div class="card shadow p-4">
            ...
            <div class="text-center">
                <asp:Button ID="btnIngresar" CssClass="btn btn-primary" runat="server" Text="Guardar ingreso nuevo"></asp:Button>
            </div>
        </div>
    </div>
