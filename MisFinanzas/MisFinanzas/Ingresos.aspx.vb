...
Public Class Ingresos
    ...
    Private Sub CargarCategorias()
        Dim query As String = "SELECT ID_Categoria, Nombre FROM Categoria_Movimiento WHERE ClaseTipoMovimiento = 1"
    ...
    Private Sub btnIngresar_Click(sender As Object, e As EventArgs) Handles btnIngresar.Click
        Try
            ...
            If rowsAffected > 0 Then
                MuestraMensaje(Me, "Ingreso agregado", "Tu ingreso ha sido agregado.", "success")
            Else
                MuestraMensaje(Me, "Error", "No se pudo agregar tu ingreso", "error")
            End If
        Catch ex As SqlClient.SqlException
            MuestraMensaje(Me, "Error", "Ocurrió un error al agregar el ingreso" & ex.ToString(), "error")
        Finally
            Conexiones.Cnn.Close()
        End Try
    End Sub
