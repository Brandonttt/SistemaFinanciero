<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pagina_Maestra.Master" CodeBehind="AnalisisTendencias.aspx.vb" Inherits="MisFinanzas.AnalisisTendencias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-4">
        <h2 class="text-center mb-4">Análisis de Tendencias</h2>
